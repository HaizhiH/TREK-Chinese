...
const { db } = vi.hoisted(() => {
  ...
  tmp.exec(`CREATE TABLE places (id INTEGER PRIMARY KEY AUTOINCREMENT, trip_id INTEGER NOT NULL, name TEXT,
    ...
    google_place_id TEXT, google_ftid TEXT, osm_id TEXT, amap_poi_id TEXT, geo_provider TEXT, provider_place_id TEXT,
    website TEXT, phone TEXT, stop_type TEXT, fill_percent INTEGER);`);

...
export interface PlaceCreateInput {
  ...
  geo_provider?: 'google' | 'openstreetmap' | 'amap' | null; provider_place_id?: string | null;
...
export class PlacesService {
  ...
  create(tripId: string, body: PlaceCreateInput) {
    const {
      ...
      place_time, end_time,
      duration_minutes, notes, image_url, google_place_id, google_ftid, osm_id, amap_poi_id, geo_provider, provider_place_id, website, phone,
    ...
    INSERT INTO places (trip_id, name, description, lat, lng, address, category_id, price, currency,
      place_time, end_time,
      duration_minutes, notes, image_url, google_place_id, google_ftid, osm_id, amap_poi_id, geo_provider, provider_place_id, website, phone, transport_mode,
  ...
  `,
      ...
      google_place_id || null, google_ftid || null, osm_id || null, amap_poi_id || null, geo_provider ?? (google_place_id ? 'google' : osm_id ? 'openstreetmap' : null), provider_place_id ?? google_place_id ?? osm_id ?? null, website || null, phone || null, transport_mode || 'walking',

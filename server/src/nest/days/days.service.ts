...
export class DaysService {
  ...
  getAssignmentsForDay(dayId: number | string) {
    ...
    SELECT da.*, p.id as place_id, p.name as place_name, p.description as place_description,
      ...
      p.image_url, p.transport_mode, p.google_place_id, p.google_ftid, p.geo_provider, p.provider_place_id, p.osm_id, p.amap_poi_id, p.website, p.phone, p.stop_type, p.fill_percent,

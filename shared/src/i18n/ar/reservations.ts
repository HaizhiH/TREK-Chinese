...
const reservations: TranslationStrings = {
  ...
  'reservations.12306.title': 'مزامنة من 12306',
  'reservations.12306.hint': 'حمّل الجدول الزمني الرسمي واختر محطات هذه الرحلة.',
  'reservations.12306.lookup': 'البحث عن القطار',
  'reservations.12306.pickStops': 'اختر محطتين على الأقل لاستخدامهما كمسار رحلتك.',

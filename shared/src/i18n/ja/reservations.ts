...
const reservations: TranslationStrings = {
  ...
  'reservations.12306.title': '12306から同期',
  'reservations.12306.hint': '公式時刻表を読み込み、この旅程で利用する駅を選択してください。',
  'reservations.12306.lookup': '列車を検索',
  'reservations.12306.pickStops': 'ルートとして使用する駅を2つ以上選択してください。',
  ...
  'reservations.12306.applied': '12306から{count}駅を追加しました。',

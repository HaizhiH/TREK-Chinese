...
const reservations: TranslationStrings = {
  ...
  'reservations.12306.title': '12306에서 동기화',
  'reservations.12306.hint': '공식 시간표를 불러오고 이 여정의 역을 선택하세요.',
  'reservations.12306.lookup': '열차 찾기',
  'reservations.12306.pickStops': '경로로 사용할 역을 두 곳 이상 선택하세요.',
  ...
  'reservations.12306.applied': '12306에서 역 {count}곳을 추가했습니다.',

...
const reservations: TranslationStrings = {
  ...
  'reservations.12306.title': '從 12306 自動同步',
  'reservations.12306.hint': '讀取官方時刻表，並選擇本次行程經過的車站。',
  'reservations.12306.lookup': '查詢車次',
  'reservations.12306.pickStops': '請選擇至少兩個車站作為本次路線。',

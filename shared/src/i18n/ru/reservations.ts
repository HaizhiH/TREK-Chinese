...
const reservations: TranslationStrings = {
  ...
  'reservations.12306.title': 'Синхронизировать с 12306',
  'reservations.12306.hint': 'Загрузите официальное расписание и выберите станции для этой поездки.',
  'reservations.12306.lookup': 'Найти поезд',
  'reservations.12306.pickStops': 'Выберите как минимум две станции для маршрута.',
  'reservations.12306.apply': 'Использовать выбранные станции',
  'reservations.12306.missingInput': 'Сначала выберите дату отправления и введите номер поезда.',
  'reservations.12306.lookupError': 'Не удалось загрузить этот поезд из 12306.',
  'reservations.12306.lookupTimeout': 'Время ожидания запроса к 12306 истекло. Повторите попытку.',
  'reservations.12306.notFound':
    'Расписание для этого поезда на выбранную дату не найдено. 12306 предоставляет расписания только примерно на 15 дней.',
  'reservations.12306.selectTwo': 'Выберите как минимум две станции.',
  'reservations.12306.geocodeError':
    'Не удалось найти станцию {station}. Проверьте настройки Amap или выберите станцию вручную.',
  'reservations.12306.applied': 'Добавлено станций из 12306: {count}.',

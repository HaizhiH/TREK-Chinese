...
export function useTripPlanner() {
  ...
  const [prefillCoords, setPrefillCoords] = useState<{ lat: number; lng: number; name?: string; address?: string; website?: string; phone?: string; osm_id?: string; geo_provider?: 'google' | 'openstreetmap' | 'amap'; provider_place_id?: string; stop_type?: RoadtripStopType | null; duration_minutes?: number } | null>(null)
  ...
  const openAddPlaceFromPoi = useCallback((
    poi: { lat: number; lng: number; name: string; address: string | null; website: string | null; phone: string | null; osm_id?: string | null; provider?: 'google' | 'openstreetmap' | 'amap'; provider_place_id?: string | null },
    dayId?: number | null,

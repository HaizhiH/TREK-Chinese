...
export const mapsApi = {
  ...
  details: (placeId: string, lang?: string, sessionToken?: string, provider?: 'google' | 'openstreetmap' | 'amap') =>
    withCachedPlace(placeId, () =>
      apiClient.get((provider || ['google', 'openstreetmap', 'amap'].includes(sessionToken || '')) ? `/maps/details/${provider || sessionToken}/${encodeURIComponent(placeId)}` : `/maps/details/${encodeURIComponent(placeId)}`, { params: { lang, sessionToken } })
